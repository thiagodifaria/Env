function Install-Observability {
    ...
    Write-Log "Iniciando instalação de observabilidade" "INFO"
    Show-Box "Instalando Ferramentas de Observabilidade" "Cyan"
    ...
    foreach ($pkg in $PackagesToInstall) {
        $current++
        Show-CategoryProgress -Category "Observability" -Current $current -Total $total
