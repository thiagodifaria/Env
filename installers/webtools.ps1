function Install-WebTools {
    ...
    Write-Log "Iniciando instalação de web tools" "INFO"
    Show-Box "Instalando Ferramentas Web" "Cyan"
    ...
    foreach ($pkg in $PackagesToInstall) {
        $current++
        Show-CategoryProgress -Category "WebTools" -Current $current -Total $total
